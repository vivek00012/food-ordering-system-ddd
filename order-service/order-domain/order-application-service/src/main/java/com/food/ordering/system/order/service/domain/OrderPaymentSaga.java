...
public class OrderPaymentSaga implements SagaStep<PaymentResponse> {
    ...
    public OrderPaymentSaga(OrderDomainService orderDomainService, OrderRepository orderRepository, OrderSagaHelper orderSagaHelper, PaymentOutboxHelper paymentOutboxHelper, ApprovalOutboxHelper approvalOutboxHelper, OrderDataMapper orderDataMapper) {
    ...
    //SAGA-STATUS : PROCESSING(Payment status:PAID) ; OUTBOX-STATUS:STARTED
    @Override
    @Transactional
    ...
    //SAGA-STATUS : COMPENSATED(Payment status:Cancelled) / COMPENSATED(Payment status:FAILED) ; OUTBOX-STATUS:STARTED
    @Override
    @Transactional
    public void rollback(PaymentResponse paymentResponse) {
        ...
        // saga status: compensated for cancelled payment status
