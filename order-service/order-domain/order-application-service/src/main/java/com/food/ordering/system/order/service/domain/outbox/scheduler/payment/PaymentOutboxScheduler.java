...
public class PaymentOutboxScheduler implements OutboxScheduler {
    ...
    public void processOutboxMessage() {
        ...
        if(outboxMessageResponse.isPresent() && outboxMessageResponse.get().size() > 0){
            ...
            log.info("Received {} for OrderPaymentOutboxMessage with ids : {}, sending to message bus!", outboxMessages.size(),
    ...
    private void updateOutboxStatus(OrderPaymentOutboxMessage orderPaymentOutboxMessage,OutboxStatus outboxStatus){
        ...
        log.info("OrderPaymentOutBoxMessage is updated with outbox status: {}",orderPaymentOutboxMessage.getId());
